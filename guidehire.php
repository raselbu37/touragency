...
$travel=new travel();
$message=$travel->SaveGuidehireInfo($_POST);
}
...
<div class="navbar navbar-inverse">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myMenu">
                    <ul class="nav navbar-nav">
						...
						<li class="active"><a href="guidehire.php">Hire Guide</a></li>
		...
		<div id="row_one">
			<div class="container">
				...
				<!-- Form Name -->
				<span class="text-danger"><i class="fa fa-2x fa-phone"></i><b style="color:#000;"><h4>Call Us +8801815547037 For Hire Guide</h4></b><span>
				<legend>Or you can fill up the guide hiring  form  below.....</legend>
				...
				<div class="form-group"> 
				  <label class="col-md-4 control-label">Packages(* maximum 5 days)</label><p> </p>
					...
					<select name="package_status" class="form-control selectpicker" required/>
					  ...
					  <option>Dhaka (TK 5000/-)</option>
					  <option>Comilla (TK 6000/-)</option>
					  <option >Chittagong (TK 7000/-)</option>
					  <option >Rangamati (TK 8000/-)</option>
					  <option >Coxs Bazar (TK 9000/-)</option>
					  <option >Saint Martin(TK 10000/-)</option>
					</select>
				  </div>
				</div>
				</div>
