            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myMenu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="package.php">Find A Package</a></li>
		...
		<div id="row_one">
			...
			<?php  while($row = mysqli_fetch_assoc($queryResult)){ ?>
				  ...
				  <div class="col-sm-4 col-md-4">
					<div class="thumbnail">
					<div>
                    <img src="admin/<?php echo $row['image'];?>" height="250" width="340"/>
					</div>
					  <div class="caption">
						
						<h3><?php echo $row['package_title'];?></h3>
						<hr/>
						<p style="text-align:justify;"><?php echo $row['package_description'];?></p>
						<div class="btn-toolbar text-center">
						  <a href="book.php" role="button" class="btn btn-success pull-right">Book Now</a>
						</div>
					  </div>
					</div>
				  </div>
