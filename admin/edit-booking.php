...
$travel=new Travel();
$queryResult=$travel->getBookingInfoById($x);
$bookingInfo=mysqli_fetch_assoc($queryResult);

if(isset($_POST['btn'])){
	$travel->updateBookingInfo($_POST, $x);
}
?>
...
<html>
 ...
 <form class="well form-horizontal" action=" " method="post"  id="contact_form" style="height:600px;">
				...
				<div class="form-group">
				  ...
				  <input  name="first_name" placeholder="First Name" value="<?php echo $bookingInfo['first_name'];?>" class="form-control"  type="text" required/>
					</div>
				  </div>
				</div>
				...
				<div class="form-group">
				  <label class="col-md-4 control-label" >Last Name</label> 
					...
					<div class="input-group">
				  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
				  <input name="last_name" placeholder="Last Name" value="<?php echo $bookingInfo['last_name'];?>"class="form-control"  type="text" required/>
					</div>
				  </div>
				</div>
				...
				<!-- Text input-->
				  ...
				  <input name="email" placeholder="E-Mail Address" value="<?php echo $bookingInfo['email'];?>"class="form-control"  type="text" required/>
					</div>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <input name="phone" placeholder="+8801815547037" value="<?php echo $bookingInfo['phone'];?>"class="form-control" type="text" required/>
					</div>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <input name="address" placeholder="Address" value="<?php echo $bookingInfo['address'];?>" class="form-control" type="text" required/>
					</div>
				  </div>
				</div>
				...
				<div class="form-group"> 
				  <label class="col-md-4 control-label">Packages (* maximum 2 person)</label>
					...
					<select name="package_status" value="<?php echo $bookingInfo['package_status'];?>" class="form-control selectpicker" required/>
				  ...
				  <label class="col-md-4 control-label">What About Your Plan for Your Tour?</label>
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
							<textarea class="form-control" cols="25" rows="5" name="comment" placeholder="Plan Description" required/><?php echo $bookingInfo['comment'];?></textarea>
				  </div>
				  </div>
				</div>
				...
				<div class="form-group">
				  <label class="col-md-4 control-label">Publication Status</label>
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
					<select name="publication_status" value="<?php echo $bookingInfo['publication_status'];?>" class="form-control selectpicker" required/>
