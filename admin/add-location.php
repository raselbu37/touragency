...
$travel=new Travel();
$message=$travel->saveLocationInfo($_POST);
}
?>
    	...
    	<div class="row">
		  ...
		  <div class="col-md-9">
			...
			<div class="well">
						 ...
						 <h2 class="text-center text-warning">Add Location Content Here</h2>
						...
						<div class="form-group">
						  ...
						  <div class="form-group">
                            ...
                            <input type="text" name="location_title" class="form-control" required/>
                         </div>
                             <div class="form-group">
                            <label>Location Description:</label> 
                            <textarea name="location_description" cols="30" rows="5" class="form-control" required/></textarea>
                         </div>
                             <div class="form-group">
