...
<html>
 ...
 <div class="panel panel-default">
                   <h2 class="text-center text-warning">View All Guide Information</h2>
...
<tr>
<td><?php echo $packInfo['guide_name'];?></td>
<td><?php echo $packInfo['guide_description'];?></td>
