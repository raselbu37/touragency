...
$travel=new Travel();
$message=$travel->saveTravelInfo($_POST);
}
?>
			...
			<div class="well">
						...
						<div class="form-group">
						  ...
						  <div class="form-group">
                            ...
                            <textarea name="package_description" cols="30" rows="5" class="form-control" required/></textarea>
                         </div>
                             <div class="form-group">
                            <label>publication Status:</label>
                              <select name="publication_status" class="form-control" required/>
                                  <option name="publication_status">---Select Publication Status---</option>
                        ...
                        <div class="form-group">
                            <input type="submit" name="btn" value="Save Package Info" class="btn btn-primary">
						</div>
							</form>
                        </div>
                   </div>
