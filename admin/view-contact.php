...
if(isset($_GET['a'])){
		$id=$_GET['id'];
		$travel->DeleteContactInfo($id);
		
}

$queryResult=$travel->getAllContactInfo();
...
<html>
 ...
 <div class="panel panel-default">
                   <h2 class="text-center text-warning">View All Contact Information Here</h2>
...
<?php while($contactInfo=mysqli_fetch_assoc($queryResult)){ ?>
<tr>
<td><?php echo $contactInfo['full_name'];?></td>
<td><?php echo $contactInfo['phone_number'];?></td>
<td><?php echo $contactInfo['email_address'];?></td>
<td><?php echo $contactInfo['message'];?></td>
<td> 
<a href="?a=b&id=<?php echo $contactInfo['id'];?>" onclick="return confirm('Are You Sure You Want To Delete This.')">Delete</a>
</td>
</tr>
<?php }?>
</table>
