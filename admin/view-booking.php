...
if(isset($_GET['a'])){
		$id=$_GET['id'];
		$travel->DeleteBookingInfo($id);
		
}

$queryResult=$travel->getAllBookingInfo();
...
<html>
 ...
 <div class="panel panel-default">
                   <h2 class="text-center text-warning">View All Booking Information Here</h2>
...
<?php while($bookingInfo=mysqli_fetch_assoc($queryResult)){ ?>
<tr>
<td><?php echo $bookingInfo['first_name'];?></td>
<td><?php echo $bookingInfo['last_name'];?></td>
<td><?php echo $bookingInfo['email'];?></td>
<td><?php echo $bookingInfo['phone'];?></td>
<td><?php echo $bookingInfo['address'];?></td>
<td><?php echo $bookingInfo['package_status'];?></td>
<td><?php echo $bookingInfo['publication_status'];?></td>
<td><?php echo $bookingInfo['comment'];?></td>
<td> 
<a href="edit-booking.php?id=<?php echo $bookingInfo['id'];?>">Edit</a>||
<a href="?a=b&id=<?php echo $bookingInfo['id'];?>" onclick="return confirm('Are You Sure You Want To Delete This.')">Delete</a>
</td>
</tr>
<?php }?>
</table>
