...
if(isset($_GET['a'])){
		$id=$_GET['id'];
		$travel->DeletePackageInfo($id);
		
}

$queryResult=$travel->getAllPackageInfo();
...
<html>
 ...
 <div class="panel panel-default">
                   <h2 class="text-center text-warning">View Package Content Here</h2>
...
<?php while($packInfo=mysqli_fetch_assoc($queryResult)){ ?>
<tr>
<td><?php echo $packInfo['package_title'];?></td>
<td><?php echo $packInfo['package_description'];?></td>
<td><?php echo $packInfo['publication_status'];?></td>
<td><img src="<?php echo $packInfo['image'];?>" height="50" width="50"></td>
<td> 
<a href="?a=b&id=<?php echo $packInfo['id'];?>" onclick="return confirm('Are You Sure You Want To Delete This.')">Delete</a>
</td>
</tr>
<?php }?>
</table>
