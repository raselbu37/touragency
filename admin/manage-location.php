...
if(isset($_GET['a'])){
		$id=$_GET['id'];
		$travel->DeleteLocationInfo($id);
		
}

$queryResult=$travel->getAllLocationInfo();
...
<html>
 ...
 <div class="panel panel-default">
                   <h2 class="text-center text-warning">View Location Content Here</h2>
		<div class="panel-body">
				...
				<?php while($locInfo=mysqli_fetch_assoc($queryResult)){ ?>
				<tr>
				<td><?php echo $locInfo['location_title'];?></td>
				<td><?php echo $locInfo['location_description'];?></td>
				<td><?php echo $locInfo['publication_status'];?></td>
				<td><img src="<?php echo $locInfo['image'];?>" height="50" width="50"></td>
				<td> 
				<a href="?a=b&id=<?php echo $locInfo['id'];?>" onclick="return confirm('Are You Sure You Want To Delete This.')">Delete</a>
				</td>
				</tr>
				<?php }?>
				</table>
